...
export const api_v1_sxwe1_list = createAsyncThunk("sxwe1s/api_v1_sxwe1_list", async payload => {
  const response = await apiService.api_v1_sxwe1_list(payload);
  return response.data;
});
export const api_v1_sxwe1_create = createAsyncThunk("sxwe1s/api_v1_sxwe1_create", async payload => {
  const response = await apiService.api_v1_sxwe1_create(payload);
  return response.data;
});
export const api_v1_sxwe1_retrieve = createAsyncThunk("sxwe1s/api_v1_sxwe1_retrieve", async payload => {
  const response = await apiService.api_v1_sxwe1_retrieve(payload);
  return response.data;
});
export const api_v1_sxwe1_update = createAsyncThunk("sxwe1s/api_v1_sxwe1_update", async payload => {
  const response = await apiService.api_v1_sxwe1_update(payload);
  return response.data;
});
export const api_v1_sxwe1_partial_update = createAsyncThunk("sxwe1s/api_v1_sxwe1_partial_update", async payload => {
  const response = await apiService.api_v1_sxwe1_partial_update(payload);
  return response.data;
});
export const api_v1_sxwe1_destroy = createAsyncThunk("sxwe1s/api_v1_sxwe1_destroy", async payload => {
...
const sxwe1sSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_sxwe1_list.pending, (state, action) => {
